...
export const odentalBusinessSubtypes = [
  "general",
  "orthodontics",
  "pediatric",
  "implants",
...
export const insertOdentalTenantSettingsSchema =
  createInsertSchema(odentalTenantSettings);
export const selectOdentalTenantSettingsSchema =
  createSelectSchema(odentalTenantSettings);
