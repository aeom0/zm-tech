...
import { dentalClinicPreset, mergeOdentalTenantConfig } from './preset'
import type { OdentalTenantConfig, OdentalTenantSettingsRow } from './types'
...
function rowToConfig(row: OdentalTenantSettingsRow): OdentalTenantConfig {
  ...
  return mergeOdentalTenantConfig(
    ...
    {
      theme: {
        primaryColor: themeOverride.primaryColor ?? dentalClinicPreset.theme.primaryColor,
        accentColor: themeOverride.accentColor ?? dentalClinicPreset.theme.accentColor,
...
export function OdentalTenantProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateLocalConfig = useCallback((partial: Partial<OdentalTenantConfig>) => {
  ...
  return <OdentalTenantContext.Provider value={value}>{children}</OdentalTenantContext.Provider>
}
