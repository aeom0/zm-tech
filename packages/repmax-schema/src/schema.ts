...
// ============================================================
export const vehicleTypeEnum = pgEnum('repmax_vehicle_type', ['CAR', 'MOTO', 'TRUCK', 'SUV'])
...
export const saleStatusEnum = pgEnum('repmax_sale_status', ['COMPLETED', 'CANCELLED', 'REFUNDED'])
export const cashSessionStatusEnum = pgEnum('repmax_cash_session_status', ['OPEN', 'CLOSED'])
export const storeUserRoleEnum = pgEnum('repmax_store_user_role', ['owner', 'cashier', 'inventory'])
...
export const products = pgTable(
  ...
  (t) => ({
    ...
    conditionIdx: index('idx_repmax_products_condition').on(t.storeId, t.condition),
  })
)
...
export const sales = pgTable(
  ...
  (t) => ({
    storeDateIdx: index('idx_repmax_sales_store_date').on(t.storeId, t.createdAt),
