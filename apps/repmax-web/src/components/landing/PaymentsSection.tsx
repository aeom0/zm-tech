  ...
  return (
    <section className="l-payments-section l-reveal">
      <div className="l-payments-inner">
        ...
        >
          Como se paga en Venezuela,
          <br />
          así lo registra RepMAX
        </h2>
        ...
        <p className="l-payments-note">
          El pago mixto permite combinar cualquier método en una misma transacción. Ideal pa&apos;
          cuando el cliente tiene parte en USD y parte en Bs.
        </p>
      </div>
    </section>
  )
