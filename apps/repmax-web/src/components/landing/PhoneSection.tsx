      ...
      <div className="l-phone-inner">
        ...
        <div className="l-phone-benefits-col">
          ...
          <p className="l-phone-desc">
            Gestiona ventas, inventario y caja desde tu teléfono. Sin laptop, sin papeles, sin
            excusas. RepMAX corre en Android y iPhone, sin conexión a internet cuando la necesitas.
          </p>
          ...
          <div className="l-phone-benefits">
            <div className="l-phone-benefit">
              ...
              <div className="l-phone-benefit-text">
                ...
                Registra una venta en menos de 10 segundos. Busca por nombre, código o vehículo
                compatible.
              </div>
            </div>
            <div className="l-phone-benefit">
              ...
              <div className="l-phone-benefit-text">
                ...
                Las ventas se guardan localmente y sincronizan cuando recuperas señal. Sin
                interrupciones.
              </div>
            </div>
            <div className="l-phone-benefit">
              ...
              <div className="l-phone-benefit-text">
                ...
                Notificación inmediata cuando una pieza llega a su mínimo. Nunca más pierdas una
                venta por falta de inventario.
              </div>
            </div>
            <div className="l-phone-benefit">
              <div className="l-phone-benefit-icon">💰</div>
              <div className="l-phone-benefit-text">
                ...
                La tasa del día siempre visible. Cobra en cualquier moneda y el sistema convierte
                automáticamente.
              </div>
            </div>
            <div className="l-phone-benefit">
              ...
              <div className="l-phone-benefit-text">
                ...
                Un mismo equipo, varios teléfonos. Cada vendedor con su cuenta, todo bajo tu
                control.
              </div>
            </div>
          </div>
