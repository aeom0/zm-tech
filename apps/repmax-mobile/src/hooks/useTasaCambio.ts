...
export function useTasaCambio(tasaManual: number, usarTasaManual: boolean): UseTasaCambioResult {
  ...
  const usdBsRateEfectivo = !usarTasaManual && tasas?.bcv.disponible ? tasas.bcv.valor : tasaManual
