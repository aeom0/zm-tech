...
const IDS_NUMERO_PARTE = new Set(['PART_NUMBER', 'MPN', 'MANUFACTURER_PART_NUMBER'])
...
export const mlCategoryService = {
  ...
  mapProductToMlAttributes(product: RepmaxProduct, attrs: MlAttribute[]): MlAttributeMapping {
  ...
  mapManualAttributes(product: RepmaxProduct, requiresColor: boolean): MlAttributeMapping {
