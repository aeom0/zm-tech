...
export function ToothComponent({
  ...
  const pieceCondition = state.condition ? TOOTH_CONDITIONS_BY_ID[state.condition] : undefined
  ...
  const occlusalCondition = occlusalCondId ? TOOTH_CONDITIONS_BY_ID[occlusalCondId] : undefined
          ...
          {isMissing ? (
            ...
            <>
              ...
              <Circle
                ...
                cy={pos.ring}
                r={RING_INNER - 1}
                fill={occlusalCondition ? conditionFillColor(occlusalCondition) : 'transparent'}
                stroke={
                  occlusalCondition ? strokeFor(occlusalCondition, false).stroke : NEUTRAL_STROKE
                }
                strokeWidth={
                  occlusalCondition ? strokeFor(occlusalCondition, false).strokeWidth : 0.8
                }
              />
            </>
          )}
