...
export function TenantLandingModern({ data }: TenantLandingProps) {
  ...
  const nameTail =
    words.length > 1 ? words[words.length - 1]! : (words[0] ?? businessName);
    ...
    >
        ...
        <div className="mt-6 grid grid-cols-3 gap-2.5">
          {[
            ...
            >
              ...
              <div className="mt-1 text-[11px] text-[rgba(29,29,31,0.45)]">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      {services.length > 0 && (
        <section className="px-5 py-12">
          <div className="mb-1.5 text-[11px] font-bold tracking-[0.15em] text-[#00b87a] uppercase">
            Servicios
          </div>
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-xs text-[rgba(29,29,31,0.5)]">
                  {service.description}
                </div>
                {!!service.duration && (
              ...
              <div className="flex-shrink-0 text-[17px] font-extrabold tracking-tight whitespace-nowrap">
                {service.price}
              </div>
            </div>
          ))}
            ...
            >
              ...
              <div className="mt-3.5 flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-[rgba(29,29,31,0.4)]">
                    {review.role}
                  </div>
                </div>
              </div>
