...
const SCREENS = [
  ...
  },
  {
    ...
    accent: "#D4AF37",
    items: [
      { name: "Ingresos hoy", service: "S/ 420", time: "↑ 12%", color: "#00695C", done: true },
      { name: "Esta semana", service: "S/ 1,840", time: "↑ 8%", color: "#00695C", done: true },
      { name: "Este mes", service: "S/ 6,240", time: "↑ 15%", color: "#00695C", done: false },
      { name: "Comisiones", service: "S/ 936", time: "↓ 3%", color: "#E91E8C", done: false },
    ],
    tab: "💰",
  },
  {
    ...
    accent: "#7B2D8E",
    items: [
      { name: "Vanessa", service: "3 citas hoy", time: "S/ 180", color: "#E91E8C", done: true },
      { name: "Stephani", service: "2 citas hoy", time: "S/ 95", color: "#7B2D8E", done: true },
      { name: "Yosaida", service: "2 citas hoy", time: "S/ 90", color: "#00BCD4", done: false },
      { name: "Romina", service: "1 cita hoy", time: "S/ 55", color: "#D4AF37", done: false },
    ],
    tab: "👥",
  },
];
