...
export default function PanelServiciosPage() {
  ...
  const categoriasError = (categoriasQuery.error as { message?: string } | null)?.message ?? null

  const [categoriaModalOpen, setCategoriaModalOpen] = useState(false)
  const [categoriaEditing, setCategoriaEditing] = useState<CategoriaRow | null>(null)
  const [categoriaDeletingId, setCategoriaDeletingId] = useState<string | null>(null)
  ...
  const [servicioDefaultCategoryId, setServicioDefaultCategoryId] = useState<string | undefined>(
    undefined
  )
