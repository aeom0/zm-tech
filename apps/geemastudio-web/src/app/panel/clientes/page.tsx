      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="relative w-full sm:max-w-xs">
          ...
          <input
            ...
            className="w-full rounded-xl border border-white/[0.08] bg-white/[0.04] py-2.5 pl-9 pr-3 text-sm text-white outline-none placeholder:text-zinc-500 focus:border-[var(--tenant-primary)]/40"
          />
        </div>
      </div>
