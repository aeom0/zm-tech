...
export const FEATURES = [
  ...
  },
  {
    icon: 'Calendar',
    title: 'Agenda Visual',
    description: 'Citas sin conflictos con vista por empleado. Reprogramar es arrastrar y soltar.',
  },
  {
    icon: 'Users',
    title: 'Gestión de Personal',
    description: 'Comisiones automáticas, horarios y rendimiento de cada miembro del equipo.',
  },
  {
    icon: 'DollarSign',
    title: 'Control de Finanzas',
    description: 'Ingresos diarios, semanales y mensuales. Cierra el mes en segundos.',
  },
  {
    icon: 'Package',
    title: 'Inventario Inteligente',
    description: 'Alertas de stock bajo automáticas. Nunca más te quedes sin insumos.',
  },
  {
    icon: 'Bell',
    title: 'Notificaciones Push',
    description: 'Recordatorios automáticos a clientes. Reduce las ausencias hasta un 40%.',
  },
  {
    icon: 'BarChart2',
    title: 'Reportes de Crecimiento',
    description: 'Métricas claras que te dicen qué servicios son más rentables y cuándo crecer.',
  },
]
