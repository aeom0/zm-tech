...
export const authCopy = {
  ...
  schemaMissingHint: 'Si recién arrancás el Hub, las tablas hub_* aún no están en Supabase.',
} as const
...
export const shellCopy = {
  ...
  dashboardEmptyBody: 'Resumen operativo de ZM Tech — clientes, proyectos y leads en tiempo real.',
  cargando: 'Cargando…',
