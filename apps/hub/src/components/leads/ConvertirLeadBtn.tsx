...
export function ConvertirLeadBtn({ leadId, origen, nombre, contacto }: ConvertirLeadBtnProps) {
  ...
  return (
    <Button variant="primary" size="sm" loading={pending} onClick={handleConvertir}>
