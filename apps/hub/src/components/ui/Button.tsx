...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  ghost: 'text-muted hover:text-foreground hover:bg-surface-elevated disabled:opacity-50',
...
export function Button({
  ...
  return (
    <button
      ...
      className={cn(
        'focus-visible:ring-accent/50 inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-colors focus-visible:ring-2 focus-visible:outline-none',
