...
export const VEHICLE_OPTIONS: {
  ...
  { value: 'CARS',  label: 'Carros', iconName: 'car-outline',  description: 'Toyota, Chevrolet, Ford y más' },
  { value: 'MOTOS', label: 'Motos',  iconName: 'motorbike',    description: 'Yamaha, Honda, Bera, Empire...' },
