      ...
      <OnboardingLayout scrollable>
        ...
        <View style={styles.cardsColumn}>
          {TIPOS.map((tipo, i) => {
            ...
            return (
              <Animated.View key={tipo.key} entering={FadeInDown.delay(i * 80).duration(400)}>
                <Pressable
                ...
                >
                  ...
                  <View style={styles.cardTexto}>
                    ...
                    <ThemedText style={[styles.cardDesc, { color: Onboarding.textSubtle }]}>
                      {tipo.descripcion}
                    </ThemedText>
                  </View>
                  ...
                  >
                    {seleccionado ? (
                      <Feather name="check" size={12} color={Colors.dark.white} />
                    ) : null}
                  </View>
                </Pressable>
              </Animated.View>
                ...
                {opcionesSubtype.map((opt) => {
                  ...
                  return (
                    <Pressable
                      ...
                      style={({ pressed }) => [pressed && styles.chipPressed, styles.chipOuter]}
                    >
                      {activo ? (
                        <LinearGradient
                        ...
                        <View style={[styles.chipInactivo, { borderColor: Onboarding.chipBorder }]}>
                          <ThemedText
                            type="small"
                            style={[styles.chipTextoInactivo, { color: Onboarding.textMuted }]}
                          >
                            {opt.label}
                          </ThemedText>
                        </View>
