...
export default function HorariosTrabajoScreen() {
  ...
  return (
    ...
    >
      ...
      >
        {ZONAS_HORARIAS_SUGERIDAS.slice(0, zonasExpandidas ? undefined : 4).map((z) => {
          const selected = z.value === draftTimezone
          return (
            <ThemedText
              key={z.value}
              style={[styles.zonaRow, selected && { color: theme.primary, fontWeight: '600' }]}
      ...
      <ThemedText type="small" style={{ color: theme.textMuted, marginBottom: Spacing.md }}>
        Cómo se muestran las horas en la agenda (los horarios de apertura/cierre siguen en 24 h para
        que sea fácil editarlos).
      </ThemedText>
        ...
        return (
          ...
          >
            <View style={styles.diaHeader}>
              <ThemedText style={{ fontWeight: '600' }}>{ETIQUETA_DIA_LABORAL[dia]}</ThemedText>
