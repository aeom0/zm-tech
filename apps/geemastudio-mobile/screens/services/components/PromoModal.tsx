        ...
        <View style={styles.overlay}>
          <View style={[styles.sheet, { backgroundColor: theme.backgroundDefault }]}>
            ...
            <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
              ...
              {items.map((line) => (
                <View key={line.tempId} style={[styles.itemCard, { borderColor: theme.border }]}>
                  <View style={styles.itemTop}>
                    <ThemedText style={styles.itemTitle} numberOfLines={1}>
                      {line.item_type === 'service' ? 'Servicio' : 'Pack'} · {labelFor(line)}
                    </ThemedText>
                  ...
                  <View style={styles.itemRow}>
                    ...
                    <View style={styles.miniField}>
                      ...
                      <TextInput
                        ...
                        onChangeText={(txt) => updateLine(line.tempId, { discounted_price: txt })}
                      />
                    </View>
                  </View>
                </View>
              ...
              <View style={styles.switchRow}>
                <ThemedText style={{ color: theme.text }}>Promo activa</ThemedText>
                <Switch
                  value={isActive}
      ...
      <Modal visible={pickerOpen} animationType="fade" transparent>
        <View style={styles.pickerOverlay}>
          <View style={[styles.pickerSheet, { backgroundColor: theme.backgroundDefault }]}>
            ...
            <ScrollView>
              <ThemedText style={[styles.pickerSection, { color: theme.primary }]}>
                Servicios
              </ThemedText>
              {services.map((s) => (
                <Pressable
