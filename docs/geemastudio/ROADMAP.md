...
- **Estado**: entregado en **`/panel/servicios`** — PR-06 (categorías + servicios) y **PR-06B** (packs + promos + `promotion_items`). _Pendiente opcional_: reorder de categorías explícito en UI si no está cubierto.
