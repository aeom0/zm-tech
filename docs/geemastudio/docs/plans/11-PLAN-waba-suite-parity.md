...
1. **Campañas/CTWA** (P1): sin schema nuevo, `config_key` bajo `category='campanas'` en `waba_config`. Port mínimo de `CampanasClient.tsx` + secciones de contenido bot. En ZM es la entrada del módulo WA.
