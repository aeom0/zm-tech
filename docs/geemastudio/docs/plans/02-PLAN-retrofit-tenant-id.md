# Plan 02 — Retrofit `tenant_id` y aislamiento multi-tenant

> **Ubicación canónica consolidada:** Plan 02. El archivo de origen se conserva temporalmente como referencia legacy.
