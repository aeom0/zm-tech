...
- **apps/web** — Next.js 15, landing pública y panel `/finanzas`.
...
- Si mobile no arranca: comprobar que `yarn install` se ejecutó en la raíz y que existe el workspace `@salonpro/shared-schema` y `@salonpro/tenant-config`.
