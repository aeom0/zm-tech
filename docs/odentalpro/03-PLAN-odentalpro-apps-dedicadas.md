...
- `packages/tenant-config` — el _mecanismo_ de tenant isolation (`TenantContext`, `useTenant()`, RLS helpers) se reutiliza; el _preset_ de Odental vive ahí pero es fijo.
...
_ZM Tech · Alberto Ortas · 2026 — documento vivo. Fase 0 marcada [x] el 23-jul-2026._
