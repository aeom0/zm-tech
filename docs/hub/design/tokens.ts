/**
 * Hub ZM Tech — tokens ZM Control.
 *
 * Familia de marca: landing (`#8B5CF6` / `#050505`).
 * Fuente visual: docs/hub/design/hub-shell.pen + design-system/tokens.md.
 * Espejo en app: apps/hub/src/lib/theme.ts
 */
...
export function hubColor(token: keyof typeof HUB_COLORS, mode: HubMode = 'dark'): string {
